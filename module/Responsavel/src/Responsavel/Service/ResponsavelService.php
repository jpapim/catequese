...
class ResponsavelService extends Entity
{
    ...
    public function getResponsavelPaginator($filter = NULL, $camposFilter = NULL)
    {
        ...
        $select = $sql->select('responsavel')->columns([
            ...
            ->join('email', 'email.id_email = responsavel.id_email', ['em_email'], 'left')
            ->join('profissao', 'profissao.id_profissao = responsavel.id_profissao', ['nm_profissao'], 'left')
            ->join('telefone','telefone.id_telefone = responsavel.id_telefone_residencial',['nr_ddd_telefone','nr_telefone'], 'left')  ;
    ...
    public function getFiltrarResponsavelPorNomeToArray($responsavel)
    {
        ...
        $select = $sql->select('responsavel')
            ->columns(['id_responsavel', 'nm_responsavel'])
            ->where([
